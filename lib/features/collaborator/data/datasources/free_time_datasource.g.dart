...
class _FreeTimeDataSource implements FreeTimeDataSource {
  _FreeTimeDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<AddFreeTimeResponse> addFreeTime({required FreeTime freeTime}) async {
    ...
    final _options = _setStreamType<AddFreeTimeResponse>(
  ...
  Future<FreeTimeListResponse> getFreeTimeList() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<FreeTimeListResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FreeTimeListResponse _value;
    try {
      _value = FreeTimeListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
